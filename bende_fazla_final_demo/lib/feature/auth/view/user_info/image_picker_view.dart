  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: CustomIconButton(onPressed: () => Navigator.pop(context), icon: AppIcons.kBackIcon),
        title: const Text(AppStrings.kAppName, style: TextStyle(color: AppColors.blackPrimary)),
